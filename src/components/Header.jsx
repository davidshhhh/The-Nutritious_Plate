            ...
            {showProductsDropdown && (
              <div className="absolute top-full left-0 pt-2 w-56 z-50">
                <div className={`rounded-xl shadow-xl py-2 transition-colors ${darkMode ? 'bg-[#2d2d2d] border border-gray-700' : 'bg-white border border-gray-100'}`}>
                  ...
                  <button className={`w-full text-left px-4 py-2.5 text-sm transition-all cursor-pointer ${darkMode ? 'text-gray-300 hover:bg-[#3d3d3d] hover:text-white' : 'text-gray-700 hover:bg-[#ebe6dd] hover:text-gray-900'}`}>
                    My Saved Recipes
                  </button>
                  <button className={`w-full text-left px-4 py-2.5 text-sm transition-all cursor-pointer ${darkMode ? 'text-gray-300 hover:bg-[#3d3d3d] hover:text-white' : 'text-gray-700 hover:bg-[#ebe6dd] hover:text-gray-900'}`}>
